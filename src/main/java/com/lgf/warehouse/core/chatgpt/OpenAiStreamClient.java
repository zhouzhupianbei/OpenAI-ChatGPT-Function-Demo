...
import com.lgf.warehouse.core.chatgpt.sse.ConsoleEventSourceListener;
...
public class OpenAiStreamClient {
    ...
    public void streamCompletions(Completion completion, EventSourceListener eventSourceListener) {
        if (Objects.isNull(eventSourceListener)) {
            log.error("参数异常：EventSourceListener不能为空，可以参考：com.lgf.warehouse.core.chatgpt.sse.ConsoleEventSourceListener");
...
//        log.info("调用查询余额请求返回值：{}", bodyStr);
    ...
    public static final class Builder {
         ...
         * api请求地址，结尾处有斜杠
         *
         * @see com.lgf.warehouse.core.chatgpt.constant.OpenAIConst
         */
        private String apiHost;
